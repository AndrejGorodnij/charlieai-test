...
### Контроль поведінки персонажа

System prompt жорстко задає межі:
- Макс 2 речення, до 40 слів, лексика A1/pre-A1
- Ніколи не каже "wrong" або "incorrect"
- Якщо дитина говорить українською — відповідає англійською, але показує що зрозумів
- Не виходить з ролі, не обговорює неприйнятні теми
